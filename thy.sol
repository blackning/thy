...
/**
 * THY Token, totalSupply 100000000000000000
 */
contract ThyToken is BurnableToken, CappedToken(100000000000000000) {
    string public name = "THY Token";
    string public symbol = "THY";
